	...
	class PlaneObject : public CObject {
  	public:
		...
		*/
		...
		void settMinus1Lat(double latitude);
		void settMinus1Lon(double longitude);
		void settMinus2Lat(double latitude);
		void settMinus2Lon(double longitude);
		...
		double gettMinus1Lat(void) const;
		double gettMinus1Lon(void) const;
		double gettMinus2Lat(void) const;
		double gettMinus2Lon(void) const;
		double getLat(void) const;
		double getLon(void) const;
		double getLastUpdateTime(void) const;
		int getLeader(void) const;
		int getFollower(void) const;
		AU_UAV_ROS::waypoint getDestination(void) const;
		bool getCheckState(void) const;
		int getFlock(void) const;
